      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-premium p-8">
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="flex flex-col space-y-2">
            <label className="text-xs font-bold text-slate-700">Needs Admin Approval for Property*</label>
            ...
            <p className="text-[10px] text-amber-600 font-medium mt-1 leading-relaxed">
              Note: if you select yes, when vendor or agent post/listing a property they need to get approval from admin to show property in frontend.
            </p>
          </div>

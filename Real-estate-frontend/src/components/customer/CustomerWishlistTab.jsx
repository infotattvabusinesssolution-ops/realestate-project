...
export default function CustomerWishlistTab({ wishlistItems = [], onRemoveWishlist, onViewProperty }) {
  return (
                  ...
                  <td className="p-3">
                    <div className="flex items-center justify-center space-x-2">
                      <button 
                        ...
                        className="px-3 py-1 border border-orange-55 hover:bg-orange-55 text-orange-500 rounded-lg text-[10px] font-bold flex items-center space-x-1.5 transition active:scale-95 shadow-xs"
                      >
                        <Eye size={12} />
                        <span>View</span>
                      </button>
                      <button 
                        ...
                        className="px-3 py-1 border border-orange-500 hover:bg-orange-55 text-orange-500 rounded-lg text-[10px] font-bold flex items-center space-x-1.5 transition active:scale-95 shadow-xs"
                      >
                        <Trash2 size={12} />
                        <span>Remove</span>
                      </button>
